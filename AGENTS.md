...
| **Private Data & Commits**| **MUST NEVER** commit or push private session data, conversation logs, scratch scripts, or transcripts to public repositories. All exports and logs MUST remain strictly in the local private `brain` folder. |
