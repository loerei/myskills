...
2. **Hero Problem-Solution Primacy**: 
...
3. **Hierarchy Separation (Core vs Extra)**:
...
4. **Ruthless Table-Stakes Pruning**:
...
5. **Strict Truthfulness to Current State**:
...
6. **No Marketing Fluff or Hype**: NEVER use AI buzzwords or promotional adjectives (`seamless`, `robust`, `powerful`, `ultra-fast`, `crisp`, `fantastic`, `revolutionary`, `flawless`). State what the tool does plainly with concrete, modest verbs.
7. **Authentic Indie Dev Empathy**: 
...
8. **Spare & Readable Layout**: Keep sentences short, paragraphs compact, and bullet points punchy. Avoid wall-of-text formatting.
...
4. **Apply Voice Constraints**: Strip all hype words, strip all exclamation marks (`!`), apply casual plain English phrasing.
