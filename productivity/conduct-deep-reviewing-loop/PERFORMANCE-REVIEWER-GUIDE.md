...
- **Rolling Inactivity vs Total Wall-Clock Timeouts**: For streaming I/O, chunked processing, or long-running pipelines, mandate rolling inactivity timeouts rather than fixed total wall-clock timers. A timeout must trigger only upon lack of forward progress over the threshold.
