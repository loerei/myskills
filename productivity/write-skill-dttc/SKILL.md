...
flowchart TD
    ...
    VerifyPosition -->|"Valid"| Step5["5. Distribute via distribute-skills.js"]
...
Sync changes across workspace targets via `node <projects_root>/distribute-skills.js --target <target-repo>`.
