...
6. **Prefer Mermaid diagrams over tables when ADHERENCE IS NEEDED.** Agent adherence drops significantly when reading flat tables for multi-branch workflows.
